...
var custom_avatar_image_path = "./images/avatar/";

eavatar.background = {
  desert:0,field:1,dungeon:2,lake:3
  ,images:[
     custom_avatar_image_path + "background/avatarBg1.png"
    ,custom_avatar_image_path + "background/avatarBg2.png"
    ,custom_avatar_image_path + "background/avatarBg3.png"
  ]
  ,loadImages:function(){
    return this.images;
  }
